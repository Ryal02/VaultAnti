    ...
    return (
        ...
        <div className='flex flex-cols gap-4 w-full overflow-auto'>
            ...
            <div className='p-2 flex flex-col border h-auto bg-slate-500 rounded-md'>
                ...
                <div className="bg-gray-800 p-6 rounded-lg shadow-lg max-full overflow-auto">
            ...
            <div className='p-2 flex flex-col border h-auto bg-slate-500 rounded-md'>
                <div className='relative flex justify-between'>
                    <span className='p-2 font-bold'>Passing all columns</span>
                    <button
                        className="relative text-white font-semibold py-2 px-4 rounded copy-button shadow-2xl hover:opacity-80"
                        onClick={handleCopyClick2}
                    >
                        Copy
                    </button>
