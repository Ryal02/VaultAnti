...
export default function App() {
    ...
    type ValidColor = "success" | "danger" | "warning" | "default" | "primary" | "secondary";
  ...
  const renderCell = React.useCallback(
    (user: ItemType, columnKey: string) => {
    ...
    return (
      ...
      <Table
        ...
        onSortChange={(sort) => {
            // Handle the case when sorting is cleared
            if (typeof sort === 'string') {
              setSortDescriptor(sort);
            } else {
              // Use type assertion here
              setSortDescriptor(sort as SortDescriptor);
            }
        }}
      >
